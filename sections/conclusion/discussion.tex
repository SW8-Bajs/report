...
\todo{do this when deisgn intro is done and final screenshots taken}
no lobby, bad
...
As explained in \autoref{sec:sec:evaluatin_test}, there were some slight issues in terms of updates when playing the game outside.
...
In order to combat these issues, we implemented lerping as described in \tocdo{autoref til lerp}.
