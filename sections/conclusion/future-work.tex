...
This was subsequently improved through an implementation of linear implementation through Unity, as described in \autoref{sec:lerping}.
...
This was a topic discussed during the test described in \autoref{sec:evaluatin_test}.
