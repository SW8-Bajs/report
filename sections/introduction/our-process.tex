...
This semester our process has been inspired by the process Essence taught in the Software Innovation course.
We have been working with a ScrumBut approach in previous semesters, but we decided that we wanted to try a different process this semester as we learned more about the Essence approach.\\
...
To make the report fit this format, it has been split into 5 sprints that we will go through during the semester, where each sprint has a length of 3 weeks.
The things that we primarily used from Essence was the team organization.
...
Another member has the \textit{Anchor} role, and is responsible for changes to the process and is in charge of leading the stand up meeting, retrospective and evaluations of the process.
