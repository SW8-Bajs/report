\section{Network packets}\label{app:network}
...
\begin{tabular}{|l|l|l|l|}
\hline
\textbf{POSY (y)} & \textbf{POSX (x)} & \textbf{TEAM\_ID (i)} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}TYPE (t)\\ 5\end{tabular}}} \\ \hline
16 bit            & 16 bit            & 8 bit                 & 8 bit                                                                              \\ \hline
\end{tabular}
\end{table}

Purpose: Sends a new goal position to the clients when a goal is scored.
The packet will be sent twice, one packet for each team with different team IDs (i).
