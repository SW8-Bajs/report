\section{Understanding a \uppaal model}\label{app:uppaal}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/applocations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/apptemplates.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appenabledtransitions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/apptransitions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appsync.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appguard.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appselection.png}
...
In \autoref{fig:app:uppaal:invariant} we have added an invariant to \appLoc{B}, specifying that less than 8 \appClock{time} units must have passed before it leaves the transition.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appinvariant.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{uppaal/appcommittedurgent.png}
