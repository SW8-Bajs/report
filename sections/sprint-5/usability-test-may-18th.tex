\section{Usability test}\label{sec:usability-18may}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{usability-18-05-2020/usability-test-indoors.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability-18-05-2020/player-tag.png}
        \caption{The player tag and a power bank.}
        \label{fig:sub1}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability-18-05-2020/ball-tag.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{usability-18-05-2020/outdoor-anchor-setup.png}
