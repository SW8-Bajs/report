...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{usability-18-05-2020/setup-indoors.png}
    \caption{The setup for the indoors playing field. The coordinate at the anchors are in cm.}
    \label{fig:test2-indoor-setup}
\end{figure}
\noindent
Doing the indoor test it was discovered that two of the Pozyx tags did not correctly send positional updates even when they reported that everything was okay doing the setup phase.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{usability-18-05-2020/usability-test-indoors.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability-18-05-2020/player-tag.jpg}
        \caption{The player tag and a power bank.}
        \label{fig:sub1}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability-18-05-2020/ball-tag.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{usability-18-05-2020/setup-outdoor.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{usability-18-05-2020/outdoor-anchor-setup}
    \caption{The setup of an anchor in the outdoor test.}
    \label{fig:test2-anchor-setup}
\end{figure}
\noindent
These anchors were connected to laptops or power banks to ensure no components would run out power during play.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{usability-18-05-2020/outdoor-usability-test.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{usability-18-05-2020/tag-on-vr-headset.png}
    \caption{}
