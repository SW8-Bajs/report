...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{usability/setupindoors.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability/playertag.png}
        \caption{The player tag and a power bank.}
        \label{fig:sub1}
    \end{subfigure}
    \begin{subfigure}{.45\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{usability/balltag.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{usability/setupoutdoor.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{usability/outdooranchorsetup.png}
