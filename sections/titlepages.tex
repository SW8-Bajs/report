...
\aautitlepage{%
  ...
  In this project, we look into how to obtain positional data, model a network protocol for transferring the data to the players, and create a virtual reality-based game that shows the data.\\
