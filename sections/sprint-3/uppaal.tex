...
\\
Additionally, three new packages, seen in \autoref{tab:player-tag}, \autoref{tab:acknowledge}, \autoref{tab:gamestart}, have been specified: Sending a player tag, sending an acknowledgment, or sending the signal to start the game.
