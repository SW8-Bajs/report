...
In the model, this is represented with the client utilizing the channel \uppChan{connect}, waiting for the host to synchronize by listening to the same channel.
