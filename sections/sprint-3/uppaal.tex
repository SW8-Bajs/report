...
With 8 bit the goal zones can not be larger than 255 cm x 255 cm, but we do consider that a reasonable size.
With 16 bit the goal zone was previous able to be 655.36 m x 655.36 m, which would give the user room for customization to have much larger goal zones, but we deemed goal zones larger than 255 cm x 255 cm unnecessary.
