...
The boxplot shows the minimum and maximum values as well as the distribution of the measurements according to what quartiles they are in.
The box is the measurements within the first and third quartile and the whiskers that are extended out from it is the measurements the outside of these quartiles.
Interestingly it is the measurements closest to the $x$-axis that are the most inaccurate.
...
The highest average deviance of all the different measurements sets was 39.5 cm in position \texttt{(0,6000)}
