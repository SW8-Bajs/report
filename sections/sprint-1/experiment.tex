...
% Uddyb hvilke settings det er og angiv kilde. FREDERIK!!
...
For \texttt{(30, 60)} the minmum $x$ value was -33.3, which is a deviation of around 60 cm and for \texttt{(120, 0)} the minimum $y$ value was -54.5 cm, which is also 54.5 cm away from the actual data point.
...
The min and max values for \texttt{x} and \texttt{y} were larger in this than the previous tag, with around 40 cm deviations.
...
\\\\
% Der skal skrives om de fejl vi fik. Blandt andet possible firmware errors og Error: No error.
