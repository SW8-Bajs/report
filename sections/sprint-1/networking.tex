...
This one-to-many approach seems suitable for this project, since it would intuitively lead to better bandwidth utilsation and does not require the receivers' addresses to be known.
