...
UNet and Photon also allows for "client-hosted" games which act like lobbies. So any client can host a game which other clients can connect to. This allows the clients to send and receive data between each other \cite{unityunet}. 
