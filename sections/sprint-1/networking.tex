...
As we need to send data over the network, it is required to define the format it is sent as.
...
\\\\
We decided to use 2 and 4 hexadecimal, so that it is in byte format and hereby straightforward to work with in \texttt{C\#}.
