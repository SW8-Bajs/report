...
Given the highest number that can be in two bytes are $2^{16} - 1$, the maximum number for the \texttt{x} and \texttt{y} positions are 65.535, which corresponds to a field size of approximately 655 by 655 meters.
\begin{table}[h!]
    \centering
