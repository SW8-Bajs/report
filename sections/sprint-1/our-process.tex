...
We have been working with a ScrumBut approach in previous semesters and at the beginning of this semester, but we decided that we wanted to try a different process this semester, and as we learned more about the Essence approach we decided to pivot, changing our process. \\
...
To make the report fit this format, it has been split into 4 sprints that we will go through during the semester, where each sprint has a length of 3 weeks.
...
Another member has the \textit{Anchor} role, and is responsible for changes to the process and is in charge of leading evaluations of the process.
