...
The test plan is our description and an agreement of what needs to be tested and how thoroughly it should be tested more details about the test plan can be found in \autoref{app:test-plan}.
