...
This can be seen on the trace of \uppTemp{TCP_client(0)}. When it sends the \uppOut{tcp_sync[0]} it timesout because it does not get a response from the \uppTemp{TCP_host(1)}.
