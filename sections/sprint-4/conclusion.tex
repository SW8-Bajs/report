...
The host also needs to send information about the amount of goals which a team needs to score before they win the game, which requires the packet containing player data and now also goal amount to be updated.
