...
\begin{table}[h!]
    \begin{tabular}{|l|l|l|l|}
        ...
        UDP & \begin{tabular}[c]{@{}l@{}}Faster than TCP\\ Less overhead because it is a \\ one way communication\end{tabular} & \begin{tabular}[c]{@{}l@{}}Not as reliable\\ No built in \\ aknowledgements\end{tabular}                                      & \begin{tabular}[c]{@{}l@{}}Because UDP does not check if \\ the clients have recieved the \\ correct packages it can send \\ updates a lot faster than TCP.\end{tabular} \\ \hline
    \end{tabular}
