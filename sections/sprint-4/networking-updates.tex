...
\end{table}     
We performed a PMI(Plus Minus Interesting) analysis on both protocols to outline the strengths and weaknesses of TCP and UDP which can be seen in \autoref{Tab:PMI-TCP-UDP}.
