...
During implementation of the networking protocol outlined in \autoref{sec:sprint3-uppaal}, problems were encountered when attempting to implement acknowledgements in the UDP based connection for game critical data.
