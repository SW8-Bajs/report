...
This would mean that whenever any message was received, it would include to required information, and no acknowledgment would be necessary as the clients normall will receive some messages if they are continuously sent.
...
\end{table}     
We performed a PMI (Plus Minus Interesting) analysis, as taught in the Software Engineering course, on both protocols to outline the strengths and weaknesses of TCP and UDP which can be seen in \autoref{Tab:PMI-TCP-UDP}.
