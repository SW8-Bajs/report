\section{Initial evaluation on May 7th}\label{sec:initial-test}
On May 7th the group met up to perform the first real evaluation test of the system, aiming to try out the full experience of the game, using the VR goggles to view the game and using the Pozyx system to generate positional data based on the movement of the players.
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.6\linewidth]{/sprint4/first-test/experiment.png}
