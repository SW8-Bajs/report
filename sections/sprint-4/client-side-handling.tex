...
\begin{figure}[H]
    ...
    \caption{Right bit shifting the message by 8 bits to get the timestamp to the back.}
...
\begin{figure}[H]
    ...
    \caption{Right bit shifting the message by 16 bits to get the player id to the back.}
