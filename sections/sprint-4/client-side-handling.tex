...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{sprint4/bit shift-illustration.png}
...
Because one decimal corresponds to four bits, the message has to be right bit shifted by 8 bits to move the timestamp to the back of the hexadecimal as illustrated on \autoref{fig:sprint4-bitshift-timestamp}.
\begin{figure}[H]
    \centering
